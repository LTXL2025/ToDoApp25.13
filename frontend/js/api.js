...
const url = "https://todoapp25-13-qu4x.onrender.com"
...
taskForm.addEventListener("submit", (event) => {
    event.preventDefault(); //stops the default reloading of browser window
    createNewTask();
});
...
// -------------------------------------TASK FUNCTIONS------------------------------------------------------
// retrieving and displaying tasks from api.js file (tasks array) ↓
    async function displayTasks() {
        ...
        try {
            ...
            function formatTask(task) {
                ...
                const done = task.completed === true ? "text-decoration-line-through opacity-50" : ""; //Class list if task if completed or not
...
// Updating the tasks (complete, mark as done)
